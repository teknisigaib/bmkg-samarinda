  ...
  const iconHtml = renderToString(
    ...
    `}>
      <div className={`
        ...
        bg-white/95 backdrop-blur-md shadow-md border border-white/50
      ...
      <div className="absolute -bottom-1 w-2 h-2 rotate-45 bg-white border-r border-b border-slate-200"></div>
    </div>
  );
...
export default function RiverMap({ initialData, onViewDetail }: RiverMapProps) {
  ...
  if (!isMounted) return <div className="h-[600px] w-full animate-pulse rounded-2xl bg-slate-100" />;
  ...
  return (
    <div className="w-full relative z-0">
      ...
      <div className="h-[600px] w-full rounded-2xl overflow-hidden border border-slate-200 shadow-2xl relative group bg-slate-50">
        ...
        {/* --- INFO WINDOW (DESAIN BARU SESUAI REFERENSI) --- */}
            ...
            {selectedLoc ? (
                <div className="animate-in fade-in slide-in-from-right-4 duration-300">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        {/* 1. Kondisi Cuaca (Style Confidence) */}
                        ...
                        {/* 2. Grid Suhu & Angin (Style Satelit tapi dipecah) */}
                        ...
                        {/* Tombol Detail (Tambahan untuk UX) */}
                        {onViewDetail && (
                            <button 
