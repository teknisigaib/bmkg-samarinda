...
// Tambahkan Helper Format Tanggal (Opsional, agar lebih rapi)
const formatDateShort = (dateStr?: string) => {
    if (!dateStr) return "-";
    // Asumsi dateStr format "YYYY-MM-DD" dari API BMKG
    const date = new Date(dateStr);
    // Format jadi "4 Feb" (Tanggal Bulan)
  ...
  return (
    <div className="w-full animate-in fade-in slide-in-from-bottom-6 duration-500">
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-slate-200 overflow-hidden relative flex flex-col max-h-[600px]">
            ...
            {/* --- HEADER KECIL (BARU) --- */}
            {/* Sticky Header agar nama lokasi selalu terlihat */}
            ...
            <div className="overflow-x-auto overflow-y-auto custom-scrollbar flex-1 bg-white">
                <table className="w-full text-left border-collapse">
                    ...
                    {/* TABLE HEADER (Sticky di bawah header nama) */}
                        ...
                        {data.forecasts && data.forecasts.length > 0 ? (
                            ...
                            <td className="px-6 py-4 whitespace-nowrap align-middle">
                                <div className="flex flex-col">
                                    ...
                                    {/* PERBAIKAN DI SINI: Gunakan fc.date */}
                                    <span className="text-[10px] font-medium text-slate-400 mt-1">
                                        {/* Jika ada fc.date gunakan, jika tidak pakai "-" */}
