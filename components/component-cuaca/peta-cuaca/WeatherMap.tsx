...
export default function WeatherMap({ data, onRefreshStations }: { data: WeatherStationData[], onRefreshStations?: () => void }) {
  ...
  let tileUrl = "https://{s}.basemaps.cartocdn.com/rastertiles/voyager/{z}/{x}/{y}{r}.png?key=cb1_32wf_1_a69d1812376e13fad46ef99a";
  let attribution = '&copy; <a href="https://carto.com/">CartoDB</a>';
  if (mapStyle === 'dark') tileUrl = "https://{s}.basemaps.cartocdn.com/dark_all/{z}/{x}/{y}{r}.png?key=cb1_32wf_1_a69d1812376e13fad46ef99a";
